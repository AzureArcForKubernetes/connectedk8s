...
helps["connectedk8s connect"] = """
    ...
    - name: Onboard a connected kubernetes cluster by specifying the https proxy, http proxy, no proxy settings.
      text: az connectedk8s connect -g resourceGroupName -n connectedClusterName --proxy-https https://proxy-url --proxy-http http://proxy-url --proxy-skip-range excludedIP,excludedCIDR,exampleCIDRfollowed,10.0.0.0/24,Arc,Microsoft.AzureMonitor.Containers
...
helps["connectedk8s update"] = """
    ...
    - name: Update proxy values for the agents
      text: az connectedk8s update -g resourceGroupName -n connectedClusterName  --proxy-cert /path/to/crt --proxy-https https://proxy-url --proxy-http http://proxy-url --proxy-skip-range excludedIP,excludedCIDR,exampleCIDRfollowed,10.0.0.0/24,Arc,Microsoft.AzureMonitor.Containers
